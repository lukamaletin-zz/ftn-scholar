...
@Service
public class RejectPaperTask implements JavaDelegate {

    private final PaperService paperService;

    private final MailService mailService;

    public RejectPaperTask(PaperService paperService, MailService mailService) {
    ...
    public void execute(DelegateExecution execution) {
        ...
        mailService.sendMail(paper.getAuthor().getEmail(), "Paper rejected");
    }
}
